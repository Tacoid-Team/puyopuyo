...
public class HighScoreActor extends Actor {
	...
	public void draw(SpriteBatch batch, float alpha) {
		String highScore = String.valueOf(ScoreManager.getInstance().getScore(screen.getGameType()));
		font.setColor(0, 0, 0, 1.0f);
		font.setScale(1.0f);
		font.draw(batch, I18nManager.getInstance().getString("record"), origX - font.getBounds(I18nManager.getInstance().getString("record")).width/2, origY + font.getLineHeight());
