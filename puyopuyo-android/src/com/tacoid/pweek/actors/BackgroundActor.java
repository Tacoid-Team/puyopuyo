...
public class BackgroundActor extends Actor{
	...
	public BackgroundActor(ScreenOrientation orientation) {
		switch(orientation) {
		case LANDSCAPE:
			SkyTex = Pweek.getInstance().manager.get("images/menu/sky.png", Texture.class);
			...
			break;
		case PORTRAIT:
			SkyTex = Pweek.getInstance().manager.get("images/menu/sky-portrait.png", Texture.class);
			SkyTex.setWrap(TextureWrap.Repeat, TextureWrap.Repeat);
		...
		HillsTex = Pweek.getInstance().manager.get("images/menu/hills.png", Texture.class);
	}
